...
puts "Flavour of Self IP Ping Issue has been seen,will Initiate a SSO if standby is ready"
...
puts "Standby Not Up, EEM script ends and will continue to check Nile Registers in next iteration..."
}
